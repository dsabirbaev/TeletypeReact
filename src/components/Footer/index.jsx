...
const index = () => {
    return (
        <footer className="pt-[64px] pb-10 px-5  border-t-[1px]">
            <div className="flex gap-x-40 items-start justify-start">
                    ...
                    <svg width="84" height="17" viewBox="0 0 84 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_1_114)">
                            <path
                                ...
                                fill="#1A1919" className="logo_svg" />
                        </g>
                        <defs>
                ...
                <ul className="text-[15px] font-medium text-[#1A1919]">
