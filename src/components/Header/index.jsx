                        ...
                        dropdown ?
                            <div onClick={() => setDropdown(!dropdown)} className="absolute w-screen h-screen bg-[#000000B3] z-40  top-[100%] left-0 pt-5 flex items-start justify-end">
                                <div onClick={(e) => e.stopPropagation()} className="dark:bg-gray-700 w-[400px]  rounded-[24px] bg-white p-5 me-5">
                                    ...
                                    <div onClick={() => getProfile()} className="flex items-center gap-x-3  px-3 py-[14px] border rounded-[16px] hover:bg-gray-100 dark:hover:bg-gray-900 cursor-pointer duration-200 mb-2">
                                        <img src={user} alt="pic" className="w-6 h-6 bg-lime-500 rounded-full" /> <span className="text-[15px] text-[#1A1919] font-semibold dark:text-white"> {localStorage.getItem("username")}</span>
                                    </div>
                                    <div onClick={() => getSettigs()} className="dark:text-white flex items-center gap-x-[2px] text-[15px] font-medium hover:bg-gray-100 dark:hover:bg-gray-900 rounded-md cursor-pointer duration-200 p-1 mb-2">
                                    ...
                                    <div onClick={() => logOut()} className="dark:text-white flex items-center gap-x-[2px] text-[15px] font-medium hover:bg-gray-100 dark:hover:bg-gray-900 rounded-md cursor-pointer duration-200 p-1">
